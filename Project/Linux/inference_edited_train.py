...
image_tensor = []
image_paths = []
for im_path in glob.glob("/home/bimbraw/Train/image_*.png"):
     print(im_path)
...
label = np.load('/home/bimbraw/Train/labels.npy')
print(label.shape)
label = label[0:1800]
...
np.save('/home/bimbraw/Train/train_time_20e_ds.npy', time_recorder)
